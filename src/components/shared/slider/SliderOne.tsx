...
//   // Effect to start/stop autoplay based on prop
//   useEffect(() => {
...
//   // 🔹 Use external refs if provided, otherwise fallback to internal
//   const prevEl = externalPrevRef?.current || internalPrevRef.current;
//   const nextEl = externalNextRef?.current || internalNextRef.current;
...
//             swiper.params.navigation.prevEl = externalPrevRef?.current || internalPrevRef.current;
//             swiper.params.navigation.nextEl = externalNextRef?.current || internalNextRef.current;
//           }
//         }}
//         onSwiper={(swiper: SwiperType) => {
//           swiperRef.current = swiper;
...
//       {/* 🔹 Only render internal navigation if no external refs are passed */}
//       {navigation && !externalPrevRef && !externalNextRef && (
//         <div className={`${navWrapperClasses[navPosition]} pointer-events-none`}>
//           <button
//             ref={internalPrevRef}
//             aria-label="Previous"
//             className="pointer-events-auto w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 hover:bg-white shadow z-20"
//           >
//             <svg className="w-3 h-3 text-green-700" viewBox="0 0 24 24" fill="none">
//               <path
//                 d="M15 6L9 12L15 18"
//                 stroke="currentColor"
//                 strokeWidth="2"
