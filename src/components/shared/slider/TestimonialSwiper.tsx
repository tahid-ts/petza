  ...
  return (
    ...
    >
      ...
      <div className="relative  max-w-[1400px] mx-auto h-full mt-10 lg:mt-0">
        <div className="absolute -left-5 bottom-0 top-0 hidden lg:block">
          <Image
            src={"/img/review/Ellipse.svg"}
            alt={"shape"}
            width={351}
            height={175}
            className="h-[351px] w-[175px]"
          />
        </div>
        ...
        <div className="relative flex justify-center ">
          <Swiper
            ...
            className="testimonial-avatar-slider h-[340px] md:h-[400px] lg:h-[346px] w-full overflow-visible z-40 flex opacity-100! [&_.swiper-slide]:opacity-100! "
            breakpoints={{
            ...
            {testimonials.map((t, index) => {
              ...
              return (
                <SwiperSlide key={t.id}>
                  <div
                    className={`relative flex lg:flex-row flex-col  items-center transition-all duration-500   lg:bg-transparent rounded-2xl lg:rounded-0  ${
                      isActive
                        ? "scale-100 z-10 xl:ml-24 lg:ml-20 ml-0"
                        : "scale-100 z-10 xl:mr-10  mr-0 xl:-ml-5 lg:ml-10"
                    }`}
                  >
                    <div className="flex lg:flex-row flex-col items-center  lg:w-[25%] gap-4">
                      ...
                      >
                        <Image
                          ...
                          alt={t.name}
                          fill
                          sizes="(max-width:768px) 100px, 100px object-contain "
                      ...
                      >
                        <div className="font-semibold leading-tight whitespace-nowrap text-xl">
                          {t.name}
                        </div>
                        <RatingStars rating={t.rating} />
                        {t.company && (
                          <div className="text-[10px] lg:text-lg text-gray-400 mt-0.5">
                            {t.company}
                          </div>
                        )}
                      </div>
...
//             }}
//             onSlideChange={(swiper) => setActiveIndex(swiper.realIndex)}
//             className="testimonial-avatar-slider h-[340px] md:h-[400px] lg:h-[450px] w-full overflow-visible z-40 flex opacity-100! [&_.swiper-slide]:opacity-100!"
//             breakpoints={{
//               1199: { slidesPerView: 3, spaceBetween: 42 },
//               991: {
//                 slidesPerView: 3,
