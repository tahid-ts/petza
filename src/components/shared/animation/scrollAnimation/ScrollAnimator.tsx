...
//   function ScrollAnimator(props, forwardedRef) {
//     const {
//       as: Tag = "div",
//       children,
//       effect = "fadeIn",
...
//       if (!forwardedRef || !el) return;

//       if (typeof forwardedRef === "function") {
//         forwardedRef(el);
//       } else if (forwardedRef && "current" in forwardedRef) {
//         (forwardedRef as React.RefObject<HTMLElement>).current = el;
//       }
//     }, [forwardedRef]);
...
//       Tag as any,
//       {
//         ref: (node: any) => (localRef.current = node),
//         className,
//         style,
//         ...rest,
//       },
