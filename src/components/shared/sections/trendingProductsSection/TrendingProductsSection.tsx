...
const products = [
  ...
  {
    id: 6,
    name: "Dog Food Vegetarian Cuisine",
    price: 90,
    image: "/img/product/product1_2.png",
  },
  {
    id: 7,
    name: "Dog Food Cuisine Puppy Pedigree",
    price: 90,
    image: "/img/product/product1_4.png",
  },
];
const TrendingProductsSection = () => {
  return (
    <div className=" h-full bg-bg-color-one relative overflow-hidden">
      <Container>
                ...
                <div className="relative w-[191px] h-[310px]">
                  ...
                  >
                    <div className="py-2 px-1 border rounded-full text-center">
                      <h1 className="text-[8px] leading-none text-white">
                        Discount
                      </h1>
            ...
            <div>
              <SliderOne
                ...
                breakpoints={{
                  ...
                  1024: { slidesPerView: 1.9, spaceBetween: 15 },
                  1124: { slidesPerView: 2, spaceBetween: 15 },
                }}
                loop={true}
                navigation={false}
                autoplayDelay={5000}
                ...
                renderItem={(products) => (
                  <ProductCard product={products} offer={true} />
                )}
              />
            </div>
          </div>
